...
type LayoutRouteId = RouteId | "/" | "/(auth)/forgot-password" | "/(auth)/login" | "/audit-logs" | "/companies" | "/dashboard" | "/enums" | "/enums/[id]" | "/enums/[id]/edit" | "/enums/create" | "/settings" | "/users" | null
